...
import com.wzy.pdmanager.DaoMaster;
import com.wzy.pdmanager.DaoSession;
...
public abstract class AbstractDatabaseManager<M, K> implements IDatabase<M, K> {
    private static final String DEFAULT_DATABASE_NAME = "lme_pw.db";
    /**
